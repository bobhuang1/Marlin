...
#define STRING_CONFIG_H_AUTHOR "Bob Huang" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 __DATE__ " " __TIME__         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Bob I3 Printer"
...
#define DEFAULT_bedKp 339.19
#define DEFAULT_bedKi 60.84
#define DEFAULT_bedKd 472.79
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 402.030457*4*2, 93*2 } // Bondtech BMG extruder is 415, but we are using DRV8825 so times two. For MK8 it's 93*2
...
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 7, 25 }
...
#define Z_PROBE_OFFSET_RANGE_MIN -21
...
#define FIL_RUNOUT_PIN  57  // 4, we do not use GPIO 4, instead we use GPIO 57, which is in the center of AUX-1, bottom row, from left to right, 5V, GND, D57, D58. Top row, 5V, GND, D1, D0
